...
@WeexComponent(names = {"select-amap"})
public class WXSelectMapComponent extends WXVContainer<FrameLayout> implements LocationSource,
    ...
    public WXSelectMapComponent(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, boolean isLazy) {
    ...
    private static class InfoWindowAdapter implements AMap.InfoWindowAdapter {
        ...
        private WXSelectMapComponent mWXMapViewComponent;

        InfoWindowAdapter(WXSelectMapComponent wxMapViewComponent) {
